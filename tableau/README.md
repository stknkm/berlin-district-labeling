...
- **District Labels Filter** showing urban typologies.
- Dynamic tooltips with population, area, and selected features.
- Clean, minimal design optimized for Tableau Public.
